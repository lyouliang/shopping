...
<template>
    <div>
        <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
            <span class="self-center text-2xl font-semibold whitespace-nowrap drop-shadow-gray-900">Apparel-Inc</span>
        </a>
    </div>
    <div>
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center">
                                                ...
                                                <defs>
                                                    ...
                                                    <filter id="filter0_d_343_121520" width="6.533" height="5.667"
                                                        ...
                                                        <feBlend in2="BackgroundImageFix"
                                                            result="effect1_dropShadow_343_121520"></feBlend>
                                        ...
                                        <div id="dropdown-phone-3"
                                            ...
                                            style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(64px, 416px);">
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div class="ms-4 text-sm">
                                            <label for="pay-on-delivery"
                                                class="font-medium leading-none text-gray-900 dark:text-white"> Payment
                                                on delivery </label>
                            ...
                            <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                                <div
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div class="ms-4 text-sm">
                                            <label for="dhl"
                                                class="font-medium leading-none text-gray-900 dark:text-white"> $15 -
                    ...
                    <div class="mt-6 w-full space-y-6 sm:mt-8 lg:mt-0 lg:max-w-xs xl:max-w-md">
                        ...
                        <div class="space-y-3">
                            ...
                            <p class="text-sm font-normal text-gray-500 dark:text-gray-400">One or more items in your
                                cart require an account. <a href="#" title=""
